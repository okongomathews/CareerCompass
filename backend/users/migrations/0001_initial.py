    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('national', 'National'), ('county', 'County'), ('private', 'Private')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('student', 'Student'), ('admin', 'Administrator'), ('school', 'School')], default='student', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kcpe_score', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('kcse_score', models.CharField(blank=True, max_length=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('school', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.school')),
                ('subjects', models.ManyToManyField(blank=True, to='recommendations.subject')),
